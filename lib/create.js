 ...
 */
Create.prototype.createFileHeader = function(data, callback) {
	var bitmap = {};
	bitmap.fileHeader = {};
 ...
 * @param {object} bitmap - Javascript object returned by @function:createFileHeader();
 * @param {buffer} data - File buffer returned from FS
 * @param {function} callback - Function to execute on callback
 * @returns {object} Further header information attached to bitmap object.
 */
Create.prototype.createInfoHeader = function(bitmap, data, callback) {
	bitmap.infoHeader = {};

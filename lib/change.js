 ...
 */
Object.prototype.changePaletteValue = function(data, arr, color, value, index, callback) {
	var i = index;
 ...
 * @returns {buffer} data - New buffer to write to new file
 */
Object.prototype.changePixelValue = function(data, arr, color, value, index, callback) {
	var i = index;
